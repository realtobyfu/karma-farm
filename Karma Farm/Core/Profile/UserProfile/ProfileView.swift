...
struct ProfileView: View {
    @State private var selectedPostFilter: ProfilePostFilterViewModel = .posts // Renamed from selectedThreadFilter
...
//                }
                ...
                UserContentListView(
                    selectedFilter: $selectedPostFilter, // Renamed from selectedThreadFilter
                    user: user
                )
            }
