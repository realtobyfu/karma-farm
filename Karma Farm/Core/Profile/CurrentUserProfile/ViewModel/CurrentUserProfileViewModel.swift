...
class CurrentUserProfileViewModel: ObservableObject {
    ...
    @Published var posts = [Post]()  // Renamed threads to posts
    @Published var replies = [PostReply]()  // Renamed ThreadReply to PostReply
    ...
    init() {
        setupSubscribers()  // Fixed typo in method name
        loadUserData()
    }
}
